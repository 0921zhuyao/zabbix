...
import com.jd.project.system.dept.service.IDeptService;
...
public class UserController extends BaseController {
	...
	public String add(ModelMap mmap) {
		mmap.put("dept", deptService.selectDeptById(100L));
	...
	public String selectDeptTree(@PathVariable("orgId") String orgId, ModelMap mmap) {
		mmap.put("org", sysorgService.selectOrgById(orgId));
		return prefix + "/tree";
	}
	...
	public List<Map<String, Object>> treeData() {
		List<Map<String, Object>> tree = sysorgService.selectOrgTree();
		return tree;
	}
	 ...
	 * 加载字典职位列表树
	 */
	@GetMapping("/treePosition")
	@ResponseBody
	public List<Map<String, Object>> treePosition() {
		List<Map<String, Object>> trees = new ArrayList<Map<String, Object>>();
		List<DictData> dictList = dictDataService.selectDictDataByType(Constants.DICT_POSITION);
		for (DictData dict : dictList) {
			Map<String, Object> dictMap = new HashMap<String, Object>();
			dictMap.put("id", dict.getDictCode());
			dictMap.put("pId", 0);
			dictMap.put("name", dict.getDictLabel());
			dictMap.put("title", dict.getDictLabel());
			trees.add(dictMap);
		}
		return trees;
	}
