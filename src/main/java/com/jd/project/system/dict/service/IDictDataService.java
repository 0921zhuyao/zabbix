...
public interface IDictDataService {
     ...
     * @return 字典标签
     */
    public DictData selectDicByTypeAndValue(@Param("dictType") String dictType, @Param("dictValue") String dictValue);
     ...
     * @return 字典数据集合信息
     */
	List<Map<String, Object>> selectDictDataTree(String dictType);
}
