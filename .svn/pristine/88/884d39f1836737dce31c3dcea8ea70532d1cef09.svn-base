package com.jd.project.tool.generator.util;
...
import com.jd.common.constant.CommonMap;
import com.jd.common.utils.DateUtils;
import com.jd.common.utils.StringUtils;
import com.jd.framework.config.GenConfig;
import com.jd.project.tool.generator.domain.ColumnInfo;
import com.jd.project.tool.generator.domain.TableInfo;
...
public class GenUtils {
     ...
     * 项目空间路径
     */
    private static final String PROJECT_PATH = "main/java/com/jd/project";
    ...
    public static List<ColumnInfo> transColums(List<ColumnInfo> columns) {
        ...
        for (ColumnInfo column : columns) {
            // 列名转换成Java属性名
            String attrName = StringUtils.convertToCamelCase(column.getColumnName(),1);
    ...
    public static String tableToJava(String tableName) {
        ...
        return StringUtils.convertToCamelCase(tableName,0);
    }
    ...
    public static String getFileName(String template, TableInfo table, String moduleName) {
        ...
        if (template.contains("list.html.vm")) {
            return htmlPath + "/" + classname + "_list.html";
        }
        if (template.contains("add.html.vm")) {
            return htmlPath + "/" + "add.html";
        }
        if (template.contains("edit.html.vm")) {
            return htmlPath + "/" + classname + "_edit.html";
        }
    ...
    public static void main(String[] args) {
        System.out.println(StringUtils.convertToCamelCase("user_name",1));
        System.out.println(replaceKeyword("岗位信息表"));
        System.out.println(getModuleName("com.jd.project.system"));
    }
}
